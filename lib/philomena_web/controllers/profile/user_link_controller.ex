defmodule PhilomenaWeb.Profile.UserLinkController do
  ...
  def index(conn, _params) do
    ...
    render(conn, "index.html", title: "Link de Artista", user_links: user_links)
  end

  def new(conn, _params) do
    changeset = UserLinks.change_user_link(%UserLink{})
    render(conn, "new.html", title: "Nuevo Link de Artista", changeset: changeset)
  end
  ...
  def show(conn, _params) do
    ...
    render(conn, "show.html", title: "Mostrando Link de artista", user_link: user_link)
  end

  def edit(conn, _params) do
    changeset = UserLinks.change_user_link(conn.assigns.user_link)

    render(conn, "edit.html", title: "Editando Link de artista", changeset: changeset)
  end
